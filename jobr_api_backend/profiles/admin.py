...
class EducationAdmin(admin.ModelAdmin):
    list_display = ('institution', 'degree', 'field_of_study', 'start_date', 'end_date', 'is_ongoing', 'employee', 'grade')
    list_filter = ('is_ongoing', 'degree', 'field_of_study', 'start_date', 'end_date')

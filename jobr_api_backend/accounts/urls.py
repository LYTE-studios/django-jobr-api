...
from .views import UserLoginView, UserRegistrationView, UserDetailView, EmployeeRegistration, EmployerRegistration, GoogleSignInView, \
    ...
    DeleteEmployerGallery, EmployeeStatisticsView, ConnectionTestView
...
urlpatterns = [
    ...
    path('gallery/employee', AllEmployeeGalleriesView.as_view(), name='all-employee-galleries'),
    path('gallery/employee/<int:pk>', EmployeeByUserView.as_view(), name='employee-galleries-by-user'),
    path('gallery/employee/update', UpdateEmployeeGalleryView.as_view(), name='update-employee-galleries'),
    path('gallery/employee/delete', DeleteEmployeeGallery.as_view(), name='delete-employee-galleries'),
    path('gallery/employer', AllEmployerGalleriesView.as_view(), name='all-employer-galleries'),
    path('gallery/employer/<int:pk>', EmployerByUserView.as_view(), name='employer-galleries-by-user'),
    path('gallery/employer/update', UpdateEmployerGalleryView.as_view(), name='update-employer-galleries'),
    path('gallery/employer/delete', DeleteEmployerGallery.as_view(), name='delete-employer-galleries'),

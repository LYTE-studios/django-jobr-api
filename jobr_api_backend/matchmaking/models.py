...
class Match(models.Model):
    ...
    match_type = models.CharField(max_length=50, choices=[('employee_to_employer', 'Employee to Employer'), ('employer_to_employee', 'Employer to Employee')])
...
class ApplyVacancy(models.Model):
    ...
    applied_at = models.DateTimeField(auto_now_add=True)  # Tracks when the application was made

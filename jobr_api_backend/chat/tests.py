...
class ChatModelsTestCase(TestCase):
    ...
    def test_chatroom_creation(self):
        self.assertEqual(str(self.chat_room), 
    ...
    def test_message_creation(self):
        self.assertEqual(str(self.message), 
                        f"Message {self.message.id} from {self.employer}")
...
class ChatAPITestCase(APITestCase):
    ...
    def test_start_chat(self):
        ...
        self.assertTrue(ChatRoom.objects.filter(
            employer=self.employer,
